...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create react-photos-3690
  fly apps create react-photos-3690-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app react-photos-3690
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app react-photos-3690-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'react-photos-3690-staging' does not match app name in config file 'react-photos-3690'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name react-photos-3690-db
  fly postgres attach --app react-photos-3690 react-photos-3690-db

  fly postgres create --name react-photos-3690-staging-db
  fly postgres attach --app react-photos-3690-staging react-photos-3690-staging-db
  ```
